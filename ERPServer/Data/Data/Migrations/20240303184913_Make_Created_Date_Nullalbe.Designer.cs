...
namespace Data.Migrations
{
    ...
    [Migration("20240303184913_Make_Created_Date_Nullalbe")]
    partial class Make_Created_Date_Nullalbe
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entities.Setup.Setting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("PurchasesBillInstructions")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SalesBillInstructions")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Data.Entities.Setup.Setting", b =>
                {
                    b.HasOne("Data.Entities.Setup.Company", "Company")
                        .WithOne("Setting")
                        .HasForeignKey("Data.Entities.Setup.Setting", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Data.Entities.Setup.ClientVendor", b =>
                {
                    b.Navigation("AccountStatementList");
